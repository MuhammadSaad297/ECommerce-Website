...
namespace ECommerce_Website.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Product_ID,Product_Name,Product_Description,Product_PurchasePrice,Product_SalePrice,Product_Picture,Category_FID")] Product product)
        {
            if (ModelState.IsValid)
            {
